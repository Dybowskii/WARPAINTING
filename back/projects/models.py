...
from miniatures.models import Element, Miniature
...
def step_image_path(i, filename):
    return f"projects/{i.project_step.project.pk}/steps/{i.project_step.pk}/{filename}"
